...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  private final com.hotel.config.SecurityProperties securityProperties;
  ...
  public WebSecurityConfig(
      ...
      com.hotel.config.SecurityProperties securityProperties,
  ...
  CorsConfigurationSource corsConfigurationSource() {
    ...
    com.hotel.config.SecurityProperties.Cors cors = securityProperties.getCors();
